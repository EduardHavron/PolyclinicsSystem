...
namespace PolyclinicsSystemBackend.Migrations
{
    ...
    [Migration("20210607213923_Added name and surname")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PolyclinicsSystemBackend.Data.Entities.Appointment.Appointment", b =>
                {
            ...
            modelBuilder.Entity("PolyclinicsSystemBackend.Data.Entities.Chat.Message", b =>
                {
            ...
            modelBuilder.Entity("PolyclinicsSystemBackend.Data.Entities.User.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PolyclinicsSystemBackend.Data.Entities.User.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PolyclinicsSystemBackend.Data.Entities.Appointment.Appointment", b =>
                {
                    ...
                    b.HasOne("PolyclinicsSystemBackend.Data.Entities.User.User", "Doctor")
                        .WithMany()
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PolyclinicsSystemBackend.Data.Entities.User.User", "Patient")
                        .WithMany()
            ...
            modelBuilder.Entity("PolyclinicsSystemBackend.Data.Entities.Chat.Message", b =>
                {
                    b.HasOne("PolyclinicsSystemBackend.Data.Entities.Appointment.Appointment", "Appointment")
                        .WithMany("Messages")
                        .HasForeignKey("AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PolyclinicsSystemBackend.Data.Entities.User.User", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("PolyclinicsSystemBackend.Data.Entities.MedicalCard.MedicalCard", b =>
                {
                    b.HasOne("PolyclinicsSystemBackend.Data.Entities.User.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
